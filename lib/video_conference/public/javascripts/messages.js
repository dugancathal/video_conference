angular.module('video_conference')
  ...
  .factory('AnnouncementMessage', ['Message', 'PeerConnector', function (Message, PeerConnector) {
  ...
  .factory('OfferDescriptionMessage', ['Message', 'PeerConnector', function (Message, PeerConnector) {
